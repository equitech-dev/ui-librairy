...
const TreeNode = ({
  ...
  const treeClasses = ['ui-tree__item', isSelected && 'ui-tree__item--selected', isDisabled && 'ui-tree__item--disabled', isDragging && 'ui-tree__item--dragging', className].filter(Boolean).join(' ');
  const toggleClasses = ['ui-tree__toggle', isExpanded && 'ui-tree__toggle--expanded', !hasChildren && 'ui-tree__toggle--hidden'].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", {
    className: "ui-tree__node"
    ...
    className: "ui-tree__icon"
  }, typeof node.icon === 'string' ? /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "currentColor",
    width: "16",
    height: "16"
  ...
  }, node.label), showActions && node.actions && /*#__PURE__*/React.createElement("div", {
    className: "ui-tree__actions"
  }, node.actions.map((action, index) => /*#__PURE__*/React.createElement("button", {
    key: index,
    type: "button",
    ...
    title: action.label
  }, action.icon)))), hasChildren && /*#__PURE__*/React.createElement("div", {
    className: `ui-tree__children ${!isExpanded ? 'ui-tree__children--collapsed' : ''}`,
    role: "group"
  }, node.children.map(child => /*#__PURE__*/React.createElement(TreeNode, {
    key: child.key,
    node: child,
    level: level + 1,
    ...
    className: "ui-tree__drop-zone ui-tree__drop-zone--active"
  }));
};
TreeNode.propTypes = {
...
const Tree = ({
  ...
  const treeClasses = ['ui-tree', `ui-tree--${size}`, `ui-tree--${variant}`, loading && 'ui-tree--loading', error && 'ui-tree--error', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", _extends({
    className: treeClasses,
    role: "tree",
    "aria-label": "Arborescence",
    id: id
  }, props), data.map(node => /*#__PURE__*/React.createElement(TreeNode, {
    key: node.key,
    node: node,
    selectedKeys: selectedKeys,
    expandedKeys: expandedKeys,
