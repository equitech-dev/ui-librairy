...
const Loading = ({
  ...
  return (
    <div className={loadingClasses} style={style}>
      ...
      {showProgress && (
        <div className="ui-loading-progress">
          <div 
      ...
      {text && (
        <div className="ui-loading-text">{text}</div>
      )}
    </div>
  );
};
...
const LoadingOverlay = ({
  ...
  const overlayClasses = [
    'ui-loading-container',
    'overlay',
    isVisible ? 'loading' : 'loaded',
    className
  ].filter(Boolean).join(' ');

  return (
    <div className={overlayClasses} style={style}>
      <Loading 
        variant="spinner"
        size="large"
        text={text}
...
const LoadingProgress = ({
  ...
  return (
    <div className={progressClasses} style={style}>
      ...
      />
      {showText && text && (
        <div className="ui-loading-text" style={{ marginTop: 'var(--spacing-xs)' }}>
          {text}
        </div>
      )}
    </div>
