...
const CalendarDay = /*#__PURE__*/React.memo(({
  day,
  date,
  isOtherMonth,
  isToday,
  ...
  const dayClasses = ['ui-calendar-day', isOtherMonth && 'ui-calendar-day--other-month', isToday && 'ui-calendar-day--today', isSelected && 'ui-calendar-day--selected', isDisabled && 'ui-calendar-day--disabled', hasEvents && 'ui-calendar-day--has-events'].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "ui-calendar-day-number"
  }, day), hasEvents && /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-day-events"
  }, events.slice(0, 3).map((event, index) => /*#__PURE__*/React.createElement("div", {
    key: index,
    className: "ui-calendar-day-event",
    style: {
      backgroundColor: event.color || '#2BA985'
    },
    title: event.title
  })), events.length > 3 && /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-day-event-more"
  }, "+", events.length - 3)));
});

// Composant de navigation optimisé
const CalendarNavigation = /*#__PURE__*/React.memo(({
  currentDate,
  onPreviousMonth,
  onNextMonth,
  onToday,
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-navigation"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-navigation-controls"
    ...
    className: "ui-calendar-view-selector"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
...
const CalendarOptimized = ({
  ...
  const calendarDays = useMemo(() => {
    ...
    for (let i = firstDayOfMonth - 1; i >= 0; i--) {
      ...
      days.push({
        ...
        isDisabled: disabledDates.some(d => dateUtils.isSameDay(date, new Date(d))) || minDate && date < new Date(minDate) || maxDate && date > new Date(maxDate),
  ...
  const calendarClasses = useMemo(() => ['ui-calendar', `ui-calendar--${size}`, `ui-calendar--${variant}`, disabled && 'ui-calendar--disabled', loading && 'ui-calendar--loading', error && 'ui-calendar--error', className].filter(Boolean).join(' '), [size, variant, disabled, loading, error, className]);
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: calendarClasses
  }, props), /*#__PURE__*/React.createElement(CalendarNavigation, {
    ...
    className: "ui-calendar-weekdays"
  }, weekDays.map((day, index) => /*#__PURE__*/React.createElement("div", {
    key: index,
    className: "ui-calendar-weekday"
  }, day))), /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-grid"
  }, calendarDays.map((dayData, index) => /*#__PURE__*/React.createElement(CalendarDay, {
  ...
  }))), showLegend && events.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-legend"
  }, /*#__PURE__*/React.createElement("h4", null, "L\xE9gende"), /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-legend-items"
  }, events.slice(0, 5).map((event, index) => /*#__PURE__*/React.createElement("div", {
    key: index,
    className: "ui-calendar-legend-item"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-calendar-legend-color",
    style: {
      backgroundColor: event.color || '#2BA985'
    }
  }), /*#__PURE__*/React.createElement("span", null, event.title))))));
};
