...
const Drawer = ({
  ...
  const drawerClasses = ['ui-drawer', `ui-drawer--${position}`, `ui-drawer--${size}`, `ui-drawer--${animation}`, theme !== 'default' && `ui-drawer--${theme}`, isOpen && 'ui-drawer--open', className].filter(Boolean).join(' ');
  const overlayClasses = ['ui-drawer-overlay', showOverlay && 'ui-drawer-overlay--visible', overlayBlur && 'ui-drawer-overlay--blur'].filter(Boolean).join(' ');
  const footerClasses = ['ui-drawer-footer', footerAlignment !== 'right' && `ui-drawer-footer--${footerAlignment}`].filter(Boolean).join(' ');
  const drawerContent = /*#__PURE__*/React.createElement(React.Fragment, null, showOverlay && /*#__PURE__*/React.createElement("div", {
    ref: overlayRef,
    ...
    id: "drawer-title",
    className: "ui-drawer-title"
  }, title), subtitle && /*#__PURE__*/React.createElement("p", {
    id: "drawer-subtitle",
    className: "ui-drawer-subtitle"
