...
const StepperStep = ({
  ...
  const stepClasses = ['ui-stepper-step-circle', isCompleted ? 'completed' : '', isActive ? 'active' : '', isError ? 'error' : '', isDisabled ? 'disabled' : ''].filter(Boolean).join(' ');
  ...
  }, showNumber && !isCompleted && !isError && index + 1), /*#__PURE__*/React.createElement("div", {
    className: "ui-stepper-step-content"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-stepper-step-label"
  }, step.label), step.description && /*#__PURE__*/React.createElement("div", {
    className: "ui-stepper-step-description"
  }, step.description)));
};
...
const Stepper = ({
  ...
  const stepperClasses = ['ui-stepper', variant !== 'horizontal' ? variant : '', size !== 'default' ? size : '', className].filter(Boolean).join(' ');
