...
const Portal = ({
  ...
  const portalClasses = [
    ...
    `ui-portal--${alignment}`,
    `ui-portal--z-${zIndex}`,
    showBackdrop && 'ui-portal--overlay',
    showBackdrop && backdropBlur && 'ui-portal--overlay-blur',
    showBackdrop && backdropVariant !== 'default' && `ui-portal--overlay-${backdropVariant}`,
    animation && `ui-portal--${animation}`,
    className
  ].filter(Boolean).join(' ');
...
export const PortalBackdrop = ({
  ...
  const backdropClasses = [
    'ui-portal-backdrop',
    variant !== 'default' && `ui-portal-backdrop--${variant}`,
    blur && 'ui-portal-backdrop--blur',
    className
  ].filter(Boolean).join(' ');
