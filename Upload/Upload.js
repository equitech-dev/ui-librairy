...
const Upload = ({
  ...
  const uploadFiles = useCallback(async () => {
    ...
    setError(null);
    try {
      const uploadPromises = files.filter(f => f.status === 'pending').map(simulateUpload);
  ...
  // Classes CSS
  const uploadClasses = ['ui-upload', size !== 'medium' && `ui-upload--${size}`, variant !== 'default' && `ui-upload--${variant}`, className].filter(Boolean).join(' ');
  const zoneClasses = ['ui-upload-zone', isDragOver && 'dragover', disabled && 'disabled'].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, customIcon || defaultIcon), /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-title"
  }, title), /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-description"
  }, description), children), error && /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-error"
  }, error), showFileList && files.length > 0 && /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-files"
  }, files.map(fileItem => /*#__PURE__*/React.createElement("div", {
    key: fileItem.id,
    className: `ui-upload-file ${fileItem.status}`
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-file-icon"
    ...
    className: "ui-upload-file-info"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-file-name"
  }, fileItem.name), /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-file-size"
  }, formatFileSize(fileItem.size)), showProgress && fileItem.status === 'uploading' && /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-progress"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "ui-upload-file-actions"
  }, fileItem.status === 'success' && /*#__PURE__*/React.createElement("button", {
    className: "ui-upload-file-action"
  }, /*#__PURE__*/React.createElement("svg", {
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
  ...
  }))))))), files.length > 0 && !uploading && /*#__PURE__*/React.createElement("button", {
    className: "ui-upload-button",
    onClick: uploadFiles,
    disabled: disabled
  }, uploading ? 'Upload en cours...' : 'Démarrer l\'upload'), uploading && /*#__PURE__*/React.createElement("div", {
    className: "ui-upload-loading"
  }, /*#__PURE__*/React.createElement("div", {
    className: "ui-spinner"
  }), /*#__PURE__*/React.createElement("span", null, "Upload en cours...")));
};
Upload.propTypes = {
