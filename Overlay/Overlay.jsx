...
const Overlay = ({
  ...
  const overlayClasses = [
    ...
    backdrop && backdropVariant !== 'default' && `ui-overlay--backdrop-${backdropVariant}`,
    backdropBlur && `ui-overlay--backdrop-blur`,
    backdropBlur && backdropBlurIntensity !== 'normal' && `ui-overlay--backdrop-blur-${backdropBlurIntensity}`,
    `ui-overlay--content-${contentPosition}`,
    `ui-overlay--${overlayAnimation}`,
    overlayAnimation === 'slide' && `ui-overlay--slide-${contentPosition}`,
    theme !== 'default' && `ui-overlay--${theme}`,
    loading && 'ui-overlay--loading',
    preventScroll && 'ui-overlay--scroll-lock',
    isOpen && 'ui-overlay--visible',
    !isOpen && 'ui-overlay--hidden',
    className
  ].filter(Boolean).join(' ');
  ...
  const contentClasses = [
    'ui-overlay-content',
    `ui-overlay-content--${contentConstraint}`,
    `ui-overlay-content--${contentAnimation}`
  ].filter(Boolean).join(' ');
  ...
  return (
    ...
    >
      ...
      <div className={contentClasses}>
        {loading ? (
          <div className="ui-loader ui-loader--spinner">
...
export const OverlayContent = ({
  ...
  const contentClasses = [
    'ui-overlay-content',
    `ui-overlay-content--${constraint}`,
    `ui-overlay-content--${animation}`,
    className
  ].filter(Boolean).join(' ');
...
export const OverlayBackdrop = ({
  ...
  const backdropClasses = [
    'ui-overlay-backdrop',
    variant !== 'default' && `ui-overlay-backdrop--${variant}`,
    blur && `ui-overlay-backdrop--blur`,
    blur && blurIntensity !== 'normal' && `ui-overlay-backdrop--blur-${blurIntensity}`,
    className
  ].filter(Boolean).join(' ');
...
export const OverlayCloseButton = ({
  ...
  const buttonClasses = [
    'ui-overlay-close',
    size !== 'md' && `ui-overlay-close--${size}`,
    theme !== 'default' && `ui-overlay-close--${theme}`,
    className
  ].filter(Boolean).join(' ');
