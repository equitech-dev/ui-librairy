...
const AccordionItem = ({
  ...
  const itemClasses = ['ui-accordion-item', isOpen ? 'expanded' : '', variant !== 'default' ? variant : '', className].filter(Boolean).join(' ');
...
const Accordion = ({
  ...
  const accordionClasses = ['ui-accordion', variant !== 'default' ? variant : '', size !== 'default' ? size : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", {
